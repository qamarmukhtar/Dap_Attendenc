...
public class Attendance_logout_list extends AppCompatActivity {
...
//        });
    ...
    private void populateRecyclerView() {
        ...
        final FirebaseRecyclerAdapter<SingleProductModel, Attendence_list.MovieViewHolder> adapter = new FirebaseRecyclerAdapter<SingleProductModel, Attendence_list.MovieViewHolder>(
                SingleProductModel.class,
                R.layout.cart_item_layout,
                Attendence_list.MovieViewHolder.class,

                //referencing the node where we want the database to store the data from our Object
//                mDatabaseReference.child("users").getRef())
                mDatabaseReference.child(DATE).child(user_logout).getRef()) {
            @Override
            protected void populateViewHolder(final Attendence_list.MovieViewHolder viewHolder, final SingleProductModel model, final int position) {
                ...
                Picasso.get().load(model.getmImageUrl()).fit().into(viewHolder.picture);
